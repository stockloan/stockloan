...
export default function Consult() {
  ...
  const { isOpen: isOpen } = useAppSelector((state) => state.betterReducer);
  ...
  const onSubmit = async (data: FormValuesProps) => {
    ...
    if (res) {
      showAlert.successAlert('상담신청이 완료되었습니다.');
    }
            ...
            <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
              <div>
                ...
                <ConsultingCheckboxContainer>
                  ...
                  <ConsultingTermsContents>
                    1. 개인정보의 위탁 <br />① 활용범위 : 주식매입자금대출
                    서비스를 제공 하는 과정에서 대출 안내 등 고객응대를 위해
                    정보 공유
...
min-h-[300px] bg-[#E3E9F6] text-center pt-[35px] pl-[30px] relative
`;
